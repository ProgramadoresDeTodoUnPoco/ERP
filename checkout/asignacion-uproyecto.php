...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            echo '<script>window.location.href = "../pages/ver-proyectos-asignados.php";</script>';
        } else {
            echo "Error al registrar la asignación: " . $stmt->errorInfo()[2];
        }
    } catch (PDOException $e) {
        // Manejar errores de manera adecuada
        echo '<script>alert("Error al registrar la asignación: ' . $e->getMessage() . '");</script>';
    }
